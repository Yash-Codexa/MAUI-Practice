...
public partial class CodeQuoates_Home : ContentPage
{
	List<String> quotes = new List<string>();
	public CodeQuoates_Home()
	{
		InitializeComponent();
	}

	private void BindingDemo_Clicked(object sender, EventArgs e)
	{
		Navigation.PushAsync(new BindingDemo());
    }
